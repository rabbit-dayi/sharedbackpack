...
SERVER_DIR="/opt/dayi/plant_bird/tffh1server"
MOD_JAR="/opt/dayi/plant_bird/cc_mod/build/libs/sharedbackpack-1.0.0.jar"
...
echo "  - Item metadata (time, count, modifier)"
